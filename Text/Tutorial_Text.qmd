...
author: "Michael J Zenz, L&S Academic Information Management"
...
[Download](https://git.doit.wisc.edu/lsaim/R-Tutorial/-/blob/main/Example_Data/pay_grades.xlsx) the pay grades .xlsx file and place it into the same "Example_Data" folder as the salary file. We are going to load it and then join it to our existing data set.
